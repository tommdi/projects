...
import { APIGatewayProxyEvent, APIGatewayProxyEventQueryStringParameters, APIGatewayProxyResult, Context} from "aws-lambda"; //Api gateway request/response
import { addCorsHeader } from '../Shared/Utils'


const TABLE_NAME = process.env.TABLE_NAME; //Name of the table from generic table
const PRIMARY_KEY = process.env.PRIMARY_KEY; //Does crud commands
